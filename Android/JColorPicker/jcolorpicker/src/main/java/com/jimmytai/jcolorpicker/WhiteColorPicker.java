...
public class WhiteColorPicker extends RelativeLayout implements View.OnTouchListener {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.WhiteColorPicker, defStyle, 0);
        indicatorRadius = a.getDimensionPixelSize(R.styleable.WhiteColorPicker_wcp_indicator_radius,
                dp2px(ColorIndicatorView.DEFAULT_RADIUS));
        indicatorActivateScale = ensureRange(a.getFloat(R.styleable.WhiteColorPicker_wcp_indicator_activate_scale,
                ColorIndicatorView.DEFAULT_ACTIVATE_SCALE), 1.f, 2.f);
        indicatorThickness = a.getDimensionPixelSize(R.styleable.WhiteColorPicker_wcp_indicator_thickness,
                dp2px(ColorIndicatorView.DEFAULT_THICKNESS));
        indicatorShadowRadius = a.getDimensionPixelSize(R.styleable.WhiteColorPicker_wcp_indicator_shadow_radius,
                dp2px(ColorIndicatorView.DEFAULT_SHADOW_RADIUS));
        indicatorShadowColor = a.getColor(R.styleable.WhiteColorPicker_wcp_indicator_shadow_color,
                ColorIndicatorView.DEFAULT_SHADOW_COLOR);
        a.recycle();
