...
public class ColorPicker extends RelativeLayout implements View.OnTouchListener {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        indicatorRadius = a.getDimensionPixelSize(R.styleable.ColorPicker_cp_indicator_radius,
                dp2px(ColorIndicatorView.DEFAULT_RADIUS));
        indicatorActivateScale = ensureRange(a.getFloat(R.styleable.ColorPicker_cp_indicator_activate_scale,
                ColorIndicatorView.DEFAULT_ACTIVATE_SCALE), 1.f, 2.f);
        indicatorThickness = a.getDimensionPixelSize(R.styleable.ColorPicker_cp_indicator_thickness,
                dp2px(ColorIndicatorView.DEFAULT_THICKNESS));
        indicatorShadowRadius = a.getDimensionPixelSize(R.styleable.ColorPicker_cp_indicator_shadow_radius,
                dp2px(ColorIndicatorView.DEFAULT_SHADOW_RADIUS));
        indicatorShadowColor = a.getColor(R.styleable.ColorPicker_cp_indicator_shadow_color,
